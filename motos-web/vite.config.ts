...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    server: {
      ...
      watch: { ignored: ['**/.figma/**'] },
      proxy: {
        '/paises': 'http://localhost:8080',
        '/divisoes': 'http://localhost:8080',
        '/cidades': 'http://localhost:8080',
        '/pessoas': 'http://localhost:8080',
        ...
        '/estoques': 'http://localhost:8080',
        '/cotacoes': 'http://localhost:8080',
        '/finalizadores': 'http://localhost:8080',
        ...
        '/estoque-produtos': 'http://localhost:8080',
